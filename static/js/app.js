...
class GameClient {
    constructor() {
        ...
        this.selectedPlanet = 'sun'; // Change default to sun
        this.playerScale = SCALE.PLAYER;
        this.lastPlayerPosition = null;
        this.PLAYER_VIEW_DISTANCE = 2; // Distance multiplier for player view
    ...
    initThree() {
        ...
        const maxDistance = ((_a = SOLAR_SYSTEM.neptune) === null || _a === void 0 ? void 0 : _a.distanceFromSun) || SOLAR_SYSTEM.earth.distanceFromSun;
    ...
    handleKeyDown(e) {
        ...
        const currentPos = ((_a = this.lastPlayerPosition) === null || _a === void 0 ? void 0 : _a.clone()) || new THREE.Vector3(0, 1, 0);
    ...
    updateWorld(worldState) {
        ...
        Object.entries(players).forEach(([id, player]) => {
            ...
            if (!playerMesh) {
                ...
                const geometry = new THREE.SphereGeometry(SOLAR_SYSTEM.earth.radius * SCALE.SIZE * SCALE.PLAYER, 32, 32);
            ...
            const surfaceNormal = new THREE.Vector3(player.position.x, player.position.y, player.position.z).normalize();
    ...
    calculateHeightAboveSurface() {
        ...
        if (heightInKm < 0.005)
            return 0.005; // Minimum 5 meters
        return heightInKm;
    }
    async loadTextureWithFallback(url, color) {
        try {
